package org.kccc.d09_asynctasktest;
...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String TAG = "D09_AsyncTaskTest";
    ...
    class AsyncDownloadTask extends AsyncTask<URL, Integer, String> {
        ...
        private String storeMP3toAsset(URL url) {
            ...
            try (FileOutputStream fos = openFileOutput(fileName, MODE_PRIVATE)) {
                ...
                int contentLenght = urlConn.getContentLength();
